...
import { changeTitleAnim } from "../SectionTitle/anim";
          ...
          <div className="relative w-full max-w-[560px] 2md:w-[clamp(424px,_24vw,_520px)]">
            ...
            >
              ...
              <h1 className="m-0 font-medium leading-[1.21] pb-[clamp(24px,_2vw,_32px)] text-[clamp(16px,_4.8vw,_24px)] w-full xs:text-[clamp(20px,_1.25vw,_26px)]">
                Front-End developer based in Oviedo, focused on building
                user-first, scalable web experiences.
              </h1>
            </motion.div>
            ...
            >
              <div className="relative bottom-0 z-10 w-full 2md:w-[clamp(424px,_24vw,_520px)]">
                <p className="text100 pb-[clamp(24px,_2vw,_32px)]">
                  <BlurryScrollText className="gap-x-0.5">
                    I believe in a clean, modern, and functional approach to web
                    development—balancing form and performance through attention
                    to detail, seamless UI, and user-first experiences. I focus
                    on creating cohesive digital products that feel intuitive,
                    fast, and visually refined.
                  </BlurryScrollText>
                </p>
            ...
            <div className="relative z-[20] flex flex-col pb-[clamp(40px,_8vw,_56px)]">
              <h3 className="m-0 text-[clamp(16px,_4.8vw,_24px)] xs:text-[clamp(20px,_1.25vw,_26px)] font-medium leading-[1.21] pb-[clamp(24px,_2vw,_32px)]">
                <BlurryScrollShortText className="gap-x-1.5">
                  Work Experience
                ...
                <div className="">
                  <p className="text100">
                    <BlurryScrollText className="gap-x-1">
                      Freelance Front-End Developer focused on creating complete
                      digital experiences. I handle visual design, full
                      development, SEO, testing, and client communication,
            ...
            <div className="relative z-[20] flex flex-col">
              <p className="text100">
                <BlurryScrollText className="gap-x-1">
                  Do not hesitate to contact me discuss a posible project or
