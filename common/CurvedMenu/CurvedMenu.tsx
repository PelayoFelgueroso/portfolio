...
export const CurvedMenu = () => {
  ...
  return (
    <motion.header
      variants={pathname === "/" ? slideDown : undefined}
      initial="initial"
      animate="entry"
      className={`${styles.header_wrapper} ${pathname === "/works" ? "bg-whiteCustom" : ""}`}
    >
      <div className={styles.header_container}>
        <Magnetic max={3}>
          <div className="relative z-[1000]">
            <Link href="/" className="logo-link-hover">
              <motion.svg
                variants={logoColor}
                initial="closed"
                ...
                className="w-[32px] h-fit 2md:w-[38px]"
              >
