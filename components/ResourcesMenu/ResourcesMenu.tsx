      ...
      <div className="relative w-full flex justify-between py-[clamp(16px,_1.4vw,_20px)] px-[clamp(16px,_1.4vw,_24px)]">
        ...
        <div className="flex gap-[15px] uppercase text-[12px] md:text-[14px]">
          <div
            ...
            className="w-[40px] h-[35px] flex justify-center items-center cursor-pointer transition-shadow duration-300 rounded-[10px] bg-[#ededed] hover:shadow-[0_0_21px_0] shadow-blueCustom hover:border border-blueCustom"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="48"
