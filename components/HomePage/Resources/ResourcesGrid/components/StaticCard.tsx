...
export const StaticCard = ({
  ...
  return (
    <div
      ...
      className={`${styles.resource_wrapper} flex flex-col justify-between w-full overflow-hidden rounded-lg text-black p-2 max-w-[400px] border-[1px] border-grayCustom bg-white`}
    >
      <div
